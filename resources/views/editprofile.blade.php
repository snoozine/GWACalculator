...
@section('content')
<form action="{{route('submitedit')}}" enctype="multipart/form-data" method="POST">
    @csrf
    @method('POST')
    ...
    <div class="setup-div container">
        <div class="profile-container container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 text-center">
                    <img class="profile-image mx-auto" src="{{ Storage::url($profile->image) }}" required />
                </div>
        ...
        <div class="info-container container">
            <h3 style="font-weight: 400" class="text-center">Edit Information</h3>
            <hr />
            <div class="inner row">
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12">
                            <input name="program" class="form-control" required value="{{$profile->program}}" />
                            <div style="padding: 10px"></div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-sm-12">Last Name:</div>
                        <div class="col-lg-8 col-md-12 col-sm-12">
                            <input name="lname" class="form-control" required value="{{$profile->lname}}" />
                            <div style="padding: 10px"></div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-sm-12">First Name:</div>
                        <div class="col-lg-8 col-md-12 col-sm-12">
                            <input name="fname" class="form-control" required value="{{$profile->fname}}" />
                            <div style="padding: 10px"></div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-sm-12">Birth Date:</div>
                        <div class="col-lg-8 col-md-12 col-sm-12">
                            <input name="bday" type="date" class="form-control" required value="{{$profile->bday}}" />
                            <div style="padding: 10px"></div>
                        </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12">
                            <input name="nationality" class="form-control" required value="{{$profile->nationality}}" />
                            <div style="padding: 10px"></div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-sm-12">Civil Status:</div>
                        <div class="col-lg-8 col-md-12 col-sm-12">
                            <input name="status" class="form-control" required value="{{$profile->status}}" />
                            <div style="padding: 10px"></div>
                        </div>
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12">
                            <input name="age" class="form-control" required value="{{$profile->age}}" />
                            <div style="padding: 10px"></div>
                        </div>
